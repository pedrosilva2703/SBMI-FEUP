...
#define BAUDGEN ((F_CPU/(16*BAUD))-1)  // Calculated divider (may under/overflow)

void usart_init(void) 
{                                 //A formula baudgen nao se applica,
  UBRR0 = 103;                    //é preciso usar o valor tabelado na datasheet
  //UBRR0H=(BAUDGEN>>8);
  //UBRR0L = BAUDGEN;
